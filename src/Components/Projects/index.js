            ...
            return (
                ...
                <header>
                    <div className="folder-svg">
                        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="-10 -10 170 40" fill="none" stroke="#F2AA4CFF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
                    </div>
