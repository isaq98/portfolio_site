...
function Navbar() {
    ...
    const renderAppropriateContent = () => {
        //Need to position the element, use z-index, and include a larger width and height in order to accomplish the vertical sidebar
        return ( hamburgerStatus ? 
            <div className="mobile-friendly-navbar"></div>
            :
            null
        )
    }
